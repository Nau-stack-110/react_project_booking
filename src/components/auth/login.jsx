            ...
            <form onSubmit={handleSubmit}>
                ...
                max-w-sm lg:max-w-4xl">
                        ...
                        <div className="w-full p-8 lg:w-1/2">
                            <h2 className="text-2xl font-semibold text-gray-700 text-center">TaxiBe Mada</h2>
                            ...
                            w-full appearance-none" name="email" type="email" value={formData.email}
                            ...
                            <div className="mt-4">
                                <div className="flex justify-between">
                                    ...
                                    <a href="#" className="text-xs text-gray-500">htmlForget Password?</a>
                                </div>

                                <input className="bg-gray-200 text-gray-700 focus:outline-none
                            focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full
                            appearance-none" type="password" name="password" value={formData.password}
                            onChange={handleChange} />
                            </div>

                            <div className="mt-8">
                                <button className="bg-gray-700 text-white font-bold py-2 px-4 w-full
                            rounded hover:bg-gray-600"  >Login</button>
                            </div>
