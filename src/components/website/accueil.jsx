...
import io from "../../assets/taxifond.webp"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-left text-white">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">
                Réservez votre TaxiBe en quelques clics
              </h1>
              <p className="text-xl mb-8">
                Voyagez en toute sécurité avec les coopératives de Madagascar
              </p>
            </div>

            {/* Colonne de droite - Formulaire */}
            <div className="bg-white/95 backdrop-blur-sm p-8 rounded-l-3xl shadow-2xl">
              <form className="space-y-4" onSubmit={handleSearch}>
                <h2 className="text-[#007E3A] text-2xl font-bold mb-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2
                     focus:ring-[#007E3A] focus:border-transparent"
                  />
                </div>

                <button className="w-full bg-[#FC3D32] hover:bg-[#d62d23] text-white font-bold py-3 px-6 rounded-lg text-lg transition duration-300">
                  Rechercher
                </button>
              </form>
            </div>
